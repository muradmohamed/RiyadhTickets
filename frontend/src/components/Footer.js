        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap">
            <div className="w-full lg:w-6/12 px-4">
              <h4 className="text-3xl text-darkblue font-semibold">
                Let's keep in touch!
              </h4>
              <h5 className="text-lg mt-0 mb-2 text-darkblue">
                Find us on any of these platforms.
              </h5>
              <div className="mt-6">
                <button
                  className="bg-white text-darkblue shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3"
                  type="button"
                >
              ...
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a className="text-darkblue hover:text-gray-900 font-semibold block pb-2 text-sm"
