            ...
            <div className="flex flex-wrap -m-2">
              <div className="p-2 w-1/2">
                <div className="relative">
                  <label for="name" className="leading-7 text-sm  font-bold">
                    Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="p-2 w-1/2">
                <div className="relative">
                  <label for="email" className="leading-7 text-sm font-bold">
                    Email
                  </label>
                  <input
                    type="email"
              ...
              <div className="p-2 w-full">
                <div className="relative">
                  <label for="message" className="leading-7 text-sm font-bold">
                    Message
                  </label>
                  <textarea
                    id="message"
                    name="message"
                    className="w-full bg-gray-50 rounded border border-graylight focus:border-indigo-500 h-32 text-base outline-none text-gray py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                  ></textarea>
                </div>
              </div>
              <div className="p-2 w-full">
                <button
                  className="flex mx-auto text-white bg-orang1 border-0 py-2 px-8 focus:outline-none  hover:bg-orang2 rounded text-lg font-bold"
                  onClick={() =>
                    Swal.fire({
