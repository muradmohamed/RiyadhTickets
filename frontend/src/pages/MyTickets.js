      ...
      {user.tickets.map((ticket, index) => 
       <div className="flex flex-col transition duration-300 bg-white rounded shadow-sm hover:shadow">
          ...
          <div className="flex flex-col justify-between flex-grow p-8 border border-purple1 border-t-0 rounded-b">
            <div>
              <div className="text-lg font-semibold text-darkblue"> Ticket Class: {ticket.class}</div>
            ...
            <a
              href="/"
              className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md  bg-orang1 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
            >
             Go To Event
            </a>
          </div>
