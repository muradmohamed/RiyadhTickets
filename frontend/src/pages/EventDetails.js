      ...
      <div className="grid max-w-screen-lg gap-8 lg:grid-cols-2 sm:mx-auto">
        ...
        <div className="grid grid-cols-2 gap-5 md:my-auto">
          ...
          <img
            ...
            alt=""
          />
          <iframe className="object-cover w-full h-48 rounded shadow-lg" src={eventsDetails.location_iframe} aria-hidden="true" frameborder="0" tabindex="-1" />
        </div>
        
      </div>
      <div className='grid grid-cols-1  pt-24 items-center '>
    <Link className="inline-block text-center  bg-orang1 border border-transparent rounded-md py-3 px-8 font-medium text-white font-bold uppercase hover:bg-indigo-700"
